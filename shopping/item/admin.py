...
from .models import Brand, Category, ItemOption, Item
...
class ItemAdmin(SummernoteModelAdmin):
	list_display = ['item_id','item_name','item_desc','price','custom_price','get_categories','brand','get_options_name','image0','detail',]
